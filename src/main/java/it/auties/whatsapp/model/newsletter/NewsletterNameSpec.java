...
public class NewsletterNameSpec {
    public static byte[] encode(NewsletterName protoInputObject) {
    ...
    public static NewsletterName decode(byte[] input) {
        if (input == null) {
            return null;
        }
    ...
    public static NewsletterName decode(ProtobufInputStream protoInputStream) {
    ...
    public static int sizeOf(NewsletterName object) {
        if (object == null) {
            return 0;
        }
        var protoSize = 0;
